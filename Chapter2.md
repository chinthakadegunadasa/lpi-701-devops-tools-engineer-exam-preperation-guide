...
```
               ...
               v                                                       v
  +--------------------------+                               +-------------------+
  |   Branching & History    |                               | Hook & Submodule  |
  |  (Trunk / Rebase / Ref)  |                               |   Orchestration   |
  +--------------------------+                               +-------------------+
               |                                                       |
        +------+------+                                         +------+------+
        |             |                                         |             |
        v             v                                         v             v
  +-----------+ +-----------+                             +-----------+ +-----------+
  | Interactive| | Advanced  |                             | Client &  | | Submodules|
  |  Rebase   | | Bisecting |                             | Server    | |  versus   |
  | & Reflog  | | Workflows |                             | Hooks     | | Subtrees  |
  +-----------+ +-----------+                             +-----------+ +-----------+
